...
public class Principal_XPath {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= losFicherosObjetos.size(); i++) {
...
//        System.out.println("Los ficheros que puede seleccionar son :" elFicheroObjetos.list(FileNameFilter)
//        );
        System.out.println("Introduzca la consulta que dese realizar sobre   *.dat que contendrá los objetos de tipo Persona.....");
        ...
        try {
            ...
            Logger.getLogger(Principal_XPath.class.getName()).log(Level.SEVERE, null, e);
        } finally {
            sc.close();
        }
    ...
    static byte pintarMenu() {
        ...
        do {
            ArrayList<String> misOpciones = new ArrayList<String>() {
                {
                    add("Busca dato en el fichero espacio.xml");
                    add("Finalizar");
                }
            };
    ...
    /**
     * Listar ficheros según su extensión. Por ejemplo: listFileByExtension
     * ("C:\\ficheros\\", ".xml", ".java");
     *
     * FilenameFilter es una interfaz que contiene únicamente el método public
     * boolean accept (File dir, String name) y devuelve true: entonces el
     * archivo se añade a la lista false: entonces no se añade el archivo a la
     * lista El método accept se llama automáticamente al realizar
     * file.listFiles(filtro)
     *
     * @param filePath path de la carpeta para listar archivos
     * @param extensiones extensiones por las que filtrar
    ...
    static void crearFicheroXML(Document documento, String nombreFichero) throws TransformerException {
        ...
        try {
            ...
            Logger.getLogger(Principal_XPath.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
